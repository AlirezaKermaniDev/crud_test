...
// in mc_crud_test/test/crud_customer/presentation/bloc/manage_customer_bloc_test/manage_customer_bloc_test.dart.
...
/// A class which mocks [GetCustomerByEmail].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetCustomerByEmail extends _i1.Mock
    implements _i3.GetCustomerByEmail {
  MockGetCustomerByEmail() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<_i2.Either<_i5.CustomerFailure, _i6.Customer>> call(
          {String? params}) =>
...
/// A class which mocks [DeleteCustomer].
///
/// See the documentation for Mockito's code generation for more information.
class MockDeleteCustomer extends _i1.Mock implements _i7.DeleteCustomer {
  MockDeleteCustomer() {
    _i1.throwOnMissingStub(this);
  }
...
/// A class which mocks [GetCustomersList].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetCustomersList extends _i1.Mock implements _i8.GetCustomersList {
  MockGetCustomersList() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<_i2.Either<_i5.CustomerFailure, List<_i6.Customer>>> call(
          {Null? params}) =>
      (super.noSuchMethod(Invocation.method(#call, [], {#params: params}),
          returnValue: Future<
