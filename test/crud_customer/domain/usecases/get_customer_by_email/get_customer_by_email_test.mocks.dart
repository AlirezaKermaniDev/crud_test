...
// in mc_crud_test/test/crud_customer/domain/usecases/get_customer_by_email/get_customer_by_email_test.dart.
...
class MockCustomerRepository extends _i1.Mock
  ...
  _i4.Future<_i2.Either<_i5.CustomerFailure, _i6.Customer>> getCustomerByEmail(
          {String? email}) =>
      (super.noSuchMethod(
              Invocation.method(#getCustomerByEmail, [], {#email: email}),
              returnValue:
                  Future<_i2.Either<_i5.CustomerFailure, _i6.Customer>>.value(
                      _FakeEither_0<_i5.CustomerFailure, _i6.Customer>()))
          as _i4.Future<_i2.Either<_i5.CustomerFailure, _i6.Customer>>);
